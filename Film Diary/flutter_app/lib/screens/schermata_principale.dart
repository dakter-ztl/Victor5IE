...
// -----------------------------------------------
// FilmDiary – SchermataPrincipale
// Statistiche del diario + navigazione.
// Banner arancione se il server non è raggiungibile.
// -----------------------------------------------
...
class _StatoSchermataPrincipale extends State<SchermataPrincipale> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Row(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.movie_creation_outlined, size: 20), SizedBox(width: 8), Text('FilmDiary')]),
        centerTitle: true,
        actions: [
          IconButton(
